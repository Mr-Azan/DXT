...
def uaku2():
	try:
		...
		a=requests.get('https://github.com/Mr-Azan/blob/main/ua2.txt').text
		ua=open('.ua2.txt','w')
...
def mobile(uid,pwx,tl):
    ...
    'cache-control':'max-age=0',
    'content-length' : '1203', 
    'content-type' : 'multipart/form-data; boundary-WebKit FormBoundary TheB48886jv80 cookie: dat=DbCGYyO2FJ7UIA; b-DbCGY_HBsPsL30agnuk.clama vpdev138668x360x2 locale=en_US; m_pixel_ratio', 
